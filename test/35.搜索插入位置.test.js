...
describe('35.搜索插入位置', () => {
  ...
  it('测试功能', () => {
    ...
    assert.equal(modInstance([1], 999), 1, 'modInstance([],999)')
    assert.equal(modInstance([1], 1), 0, 'modInstance([],999)')
    assert.equal(modInstance([1, 2], 999), 2, 'modInstance([],999)')
    assert.equal(modInstance([1, 2], 2), 1, 'modInstance([],999)')
  })
})
